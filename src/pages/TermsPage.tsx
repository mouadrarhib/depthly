...
const TOC_ITEMS = [
  ...
  { id: 'ugc', label: '9. USER GENERATED CONTRIBUTIONS' },
  { id: 'license', label: '10. CONTRIBUTION LICENSE' },
  { id: 'socialmedia', label: '11. SOCIAL MEDIA' },
  { id: 'thirdparty', label: '12. THIRD-PARTY WEBSITES AND CONTENT' },
  { id: 'sitemanage', label: '13. SERVICES MANAGEMENT' },
  { id: 'ppno', label: '14. PRIVACY POLICY' },
  { id: 'copyrightno', label: '15. COPYRIGHT INFRINGEMENTS' },
  { id: 'terms', label: '16. TERM AND TERMINATION' },
  ...
  { id: 'disclaimer', label: '21. DISCLAIMER' },
  { id: 'liability', label: '22. LIMITATIONS OF LIABILITY' },
  { id: 'indemnification', label: '23. INDEMNIFICATION' },
  { id: 'userdata', label: '24. USER DATA' },
  { id: 'electronic', label: '25. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES' },
  { id: 'misc', label: '26. MISCELLANEOUS' },
  { id: 'addclause', label: '27. PLAN CHANGES AND SERVICE AVAILABILITY' },
...
export function TermsPage() {
  return (
    <LegalLayout title="Terms of Service" lastUpdated="July 20, 2026">
      {/* Preamble */}
      <h2 style={h2Style}>AGREEMENT TO OUR LEGAL TERMS</h2>
      <p style={pStyle}>
        We are Depthly ("Company," "we," "us," "our").
      </p>
      <p style={pStyle}>
      ...
      <p style={pStyle}>
        Depthly is a focus session and time-tracking web application for students, freelancers, and
        developers. Users track deep work sessions with a Pomodoro/custom timer, organize work into
        projects and tasks (list and kanban views), and review their focus habits through daily,
        weekly, monthly, and yearly analytics. Depthly includes an optional public leaderboard and
        profile system, and offers a free plan alongside a paid subscription tier with expanded
        limits and features.
      </p>
      <p style={pStyle}>
        You can contact us by email at <a href={MAILTO} style={linkStyle}>{EMAIL}</a>.
      </p>
      <p style={pStyle}>
        These Legal Terms constitute a legally binding agreement made between you, whether
        personally or on behalf of an entity ("you"), and Depthly, concerning your access to
      ...
      <p style={pStyle}>
        Users will be notified of material changes to these Terms by an updated "Last updated" date
        at the top of this page. Continued use of the Service after such changes constitutes
      ...
      <p style={pStyle}>
        ...
        to use the Services. If you are a minor, you must have your parent or guardian read and
        agree to these Legal Terms prior to you using the Services.
      </p>
      <p style={pStyle}>We recommend that you print a copy of these Legal Terms for your records.</p>

      {/* Table of contents */}
      <div style={{ marginTop: 32, paddingTop: 32, borderTop: '0.5px solid #2E2E38' }}>
        <h2 style={{ ...h2Style, marginBottom: 12 }}>TABLE OF CONTENTS</h2>
        <nav
          style={{
            display: 'grid',
      ...
      <Section id="ip" number={2} title="INTELLECTUAL PROPERTY RIGHTS">
        ...
        <p style={pStyle}>
          ...
          <a href="#prohibited" style={linkStyle}>PROHIBITED ACTIVITIES</a>" section below, we
          grant you a non-exclusive, non-transferable, revocable license to:
        </p>
        <ul style={ulStyle}>
          <li style={pStyle}>access the Services; and</li>
          <li style={pStyle}>
            download or print a copy of any portion of the Content to which you have properly
            gained access,
          </li>
        </ul>
        <p style={pStyle}>solely for your personal, non-commercial use.</p>
        <p style={pStyle}>
        ...
        <p style={pStyle}>
          ...
          <a href={MAILTO} style={linkStyle}>{EMAIL}</a>. If we ever grant you the permission to
        ...
        <p style={pStyle}>
          ...
          <a href="#prohibited" style={linkStyle}>PROHIBITED ACTIVITIES</a>" section carefully
        ...
        <p style={pStyle}>
          <strong style={{ color: '#E8E6F0' }}>Submissions:</strong> By directly sending us any
        ...
        <p style={pStyle}>
          <strong style={{ color: '#E8E6F0' }}>Contributions:</strong> The Services may invite you
          to chat, contribute to, or participate in blogs, message boards, online forums, and other
        ...
        <p style={pStyle}>
          <strong style={{ color: '#E8E6F0' }}>You are responsible for what you post or
          upload:</strong> By sending us Submissions and/or posting Contributions through any part
          of the Services or making Contributions accessible through the Services by linking your
          account through the Services to any of your social networking accounts, you:
        </p>
        <ul style={ulStyle}>
          <li style={pStyle}>
            confirm that you have read and agree with our "
            <a href="#prohibited" style={linkStyle}>PROHIBITED ACTIVITIES</a>" and will not post,
        ...
        <p style={pStyle}>
          <strong style={{ color: '#E8E6F0' }}>We may remove or edit your Content:</strong>{' '}
          ...
          we consider such Contributions harmful or in breach of these Legal Terms. If we remove or
          edit any such Contributions, we may also suspend or disable your account and report you to
          the authorities.
        </p>
        ...
        <p style={pStyle}>
          ...
          <a href="#copyrightno" style={linkStyle}>COPYRIGHT INFRINGEMENTS</a>" section below.
        </p>
      </Section>
      ...
      <Section id="purchases" number={5} title="PURCHASES AND PAYMENT">
        <p style={pStyle}>We accept the following forms of payment:</p>
        <ul style={ulStyle}>
          <li style={pStyle}>Visa</li>
          <li style={pStyle}>Mastercard</li>
          <li style={pStyle}>American Express</li>
          <li style={pStyle}>Discover</li>
          <li style={pStyle}>PayPal</li>
        </ul>
        <p style={pStyle}>
      ...
      <Section id="subscriptions" number={6} title="SUBSCRIPTIONS">
      ...
      <Section id="software" number={7} title="SOFTWARE">
        <p style={pStyle}>
          ...
          you a non-exclusive, revocable, personal, and non-transferable license to use such
          ...
          merchantability, fitness for a particular purpose, or non-infringement. You accept any and
      ...
      <Section id="prohibited" number={8} title="PROHIBITED ACTIVITIES">
        ...
        <p style={pStyle}>As a user of the Services, you agree not to:</p>
        <ul style={ulStyle}>
          <li style={pStyle}>
          ...
          <li style={pStyle}>Disparage, tarnish, or otherwise harm, in our opinion, us and/or the Services.</li>
          <li style={pStyle}>Use any information obtained from the Services in order to harass, abuse, or harm another person.</li>
          <li style={pStyle}>Make improper use of our support services or submit false reports of abuse or misconduct.</li>
          <li style={pStyle}>Use the Services in a manner inconsistent with any applicable laws or regulations.</li>
          <li style={pStyle}>Engage in unauthorized framing of or linking to the Services.</li>
          <li style={pStyle}>
          ...
          <li style={pStyle}>Delete the copyright or other proprietary rights notice from any Content.</li>
          <li style={pStyle}>Attempt to impersonate another user or person or use the username of another user.</li>
          <li style={pStyle}>
          ...
          <li style={pStyle}>Interfere with, disrupt, or create an undue burden on the Services or the networks or services connected to the Services.</li>
          <li style={pStyle}>Harass, annoy, intimidate, or threaten any of our employees or agents engaged in providing any portion of the Services to you.</li>
          <li style={pStyle}>Attempt to bypass any measures of the Services designed to prevent or restrict access to the Services, or any portion of the Services.</li>
          <li style={pStyle}>Copy or adapt the Services' software, including but not limited to Flash, PHP, HTML, JavaScript, or other code.</li>
          <li style={pStyle}>
          ...
          <li style={pStyle}>Use a buying agent or purchasing agent to make purchases on the Services.</li>
          <li style={pStyle}>
          ...
          <li style={pStyle}>Use the Services to advertise or offer to sell goods and services.</li>
          <li style={pStyle}>Sell or otherwise transfer your profile.</li>
        </ul>
      </Section>
      ...
      <Section id="ugc" number={9} title="USER GENERATED CONTRIBUTIONS">
        ...
        <ul style={ulStyle}>
          ...
          <li style={pStyle}>Your Contributions are not false, inaccurate, or misleading.</li>
          <li style={pStyle}>
          ...
          <li style={pStyle}>Your Contributions do not ridicule, mock, disparage, intimidate, or abuse anyone.</li>
          <li style={pStyle}>
          ...
          <li style={pStyle}>Your Contributions do not violate any applicable law, regulation, or rule.</li>
          <li style={pStyle}>Your Contributions do not violate the privacy or publicity rights of any third party.</li>
          <li style={pStyle}>
      ...
      <Section id="socialmedia" number={11} title="SOCIAL MEDIA">
        <p style={pStyle}>
          ...
          granting us access to any Third-Party Accounts, you understand that (1) we may access,
          make available, and store (if applicable) any content that you have provided to and
          stored in your Third-Party Account (the "Social Network Content") so that it is available
          on and through the Services via your account, including without limitation any friend
          ...
          your account on the Services and your Third-Party Accounts at any time. PLEASE NOTE THAT
      ...
      <Section id="thirdparty" number={12} title="THIRD-PARTY WEBSITES AND CONTENT">
        <p style={pStyle}>
          ...
          does not imply approval or endorsement thereof by us. If you decide to leave the Services
          ...
          Third-Party Websites will be through other websites and from other companies, and we take
          no responsibility whatsoever in relation to such purchases which are exclusively between
      ...
      <Section id="ppno" number={14} title="PRIVACY POLICY">
        <p style={pStyle}>
          We care about data privacy and security. By using the Services, you agree to be bound by
          our <Link to={PATHS.privacy} style={linkStyle}>Privacy Policy</Link> posted on the
          Services, which is incorporated into these Legal Terms.
        </p>
      </Section>

      <Section id="copyrightno" number={15} title="COPYRIGHT INFRINGEMENTS">
        <p style={pStyle}>
          We respect the intellectual property rights of others. If you believe that any material
          available on or through the Services infringes upon any copyright you own or control,
          ...
          applicable law you may be held liable for damages if you make material misrepresentations
      ...
      <Section id="law" number={18} title="GOVERNING LAW">
        <p style={pStyle}>
          These Legal Terms shall be governed by and defined following applicable law. Depthly and
          yourself irrevocably consent that the applicable courts shall have exclusive jurisdiction
      ...
      <Section id="disputes" number={19} title="DISPUTE RESOLUTION">
        ...
        <p style={pStyle}>
          ...
          either you or us (individually, a "Party" and collectively, the "Parties"), the Parties
        ...
        <p style={pStyle}>
          If the parties are unable to resolve the dispute through informal negotiation, the
          dispute shall be finally resolved by arbitration in accordance with the United Nations
          Commission on International Trade Law Arbitration Rules in force at the time of
          commencement of the arbitration. The number of arbitrators shall be one (1). The language
          of the proceedings shall be English. The governing law of these Legal Terms shall be the
          substantive law applicable to Depthly.
        </p>
      ...
      <Section id="liability" number={22} title="LIMITATIONS OF LIABILITY">
        ...
        <p style={pStyle}>
          ...
          APPLY TO YOU, SOME OR ALL OF THE ABOVE DISCLAIMERS OR LIMITATIONS MAY NOT APPLY TO YOU, AND
      ...
      <Section id="indemnification" number={23} title="INDEMNIFICATION">
        <p style={pStyle}>
          ...
          via the Services. Notwithstanding the foregoing, we reserve the right, at your expense, to
      ...
      <Section id="addclause" number={27} title="PLAN CHANGES AND SERVICE AVAILABILITY">
        <p style={pStyle}>
          We may modify, add, or remove features and usage limits associated with the Free and Pro
          plans at any time, with such changes applying prospectively to existing and future users.
          The Service is developed, provided, and maintained by an individual developer, and we do
          not guarantee any specific uptime, response time, or availability of customer support.
        </p>
      </Section>
      ...
      <Section id="contact" number={28} title="CONTACT US">
        ...
        <p style={{ ...pStyle, marginTop: -6 }}>
          <strong style={{ color: '#E8E6F0' }}>Depthly</strong>
          <br />
          <a href={MAILTO} style={linkStyle}>{EMAIL}</a>
        </p>
      </Section>
